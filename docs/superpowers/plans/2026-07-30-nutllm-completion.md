...
- [x] **Step 1: Declare the packed kernel**
...
- [x] **Step 2: Add packed output to every correctness size**
...
- [x] **Step 1: Implement shape validation and scratch ownership**
...
- [x] **Step 4: Run the correctness gate**
...
- [x] **Step 4: Mark the optional experiment complete**
...
- [x] **Step 2: Rewrite all 83 first-party Markdown em dashes**

Edit each occurrence according to its sentence. Do not change technical meaning
or measured values.

- [x] **Step 3: Verify zero occurrences**
...
- [x] **Step 3: Run the checked-in tiny model fixtures**
